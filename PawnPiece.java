...
public class PawnPiece extends EuropeanChessPiece {
	...
	public PawnPiece(ChessBoard chessBoard) {
		this.setLabel("P");
	...
	public void moveDone() {
		...
		if( ( (this.getSide() == ChessGame.Side.NORTH || this.getSide() == ChessGame.Side.EAST) 
				&& (this.getRow() == (this.getChessBoard().numRows() - 1)) ) 
				...
				&& (this.getRow() == 0) ) )
		{
			...
			switch (readInputChar())
			{
				case 'N':
					...
					KnightPiece n = new KnightPiece(this.getChessBoard());
					n.setSide(this.getSide());
				...
				case 'R':
					...
					RookPiece r = new RookPiece(this.getChessBoard());
				...
				case 'B':
					...
					BishopPiece b = new BishopPiece(this.getChessBoard());
					b.setSide(this.getSide());
				...
				case 'Q':
					...
					QueenPiece q = new QueenPiece(this.getChessBoard());
					q.setSide(this.getSide());
